...
document.getElementById("matchForm").addEventListener("submit", function(event) {
    ...
    let AutonomusScore = GetAl1_01 * 3 + GetAl2_02 * 4 + GetAl3_03 * 6 + GetAl4_04 * 7 + GetAan_06 * 4 + GetAap_07 * 6 + AutoLeaveScore;
    ...
    let TeleOpScore = GetTl1_09 * 2 + GetTl2_10 * 3 + GetTl3_11 * 4 + GetTl4_12 * 5 + GetTan_14 * 4 + GetTap_15 * 6 + parkScore;
